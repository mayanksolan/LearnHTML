    ...
    render(){
        ...
        <React.Fragment>
          <div style={{display: this.state.isLoggedIn ? "block" : "none"}}>
            <GameHeader/>
            <Route exact path="/innerHome" render={() => (<InnerHome cookies={this.props.cookies}/>)} />
            ...
            <Route exact path="/innerSection" render={() => (<InnerSection cookies={this.props.cookies}/>)} />
          ...
          <div style={{display: !this.state.isLoggedIn ? "block" : "none"}}>
            <NoLoginHeader />
            <div style={{display: this.state.page === "login" ? "block" : "none"}}>
              <LoginPlayer currentpage={this.changePageContext} authenticate={this.authenticateUser} cookies={this.props.cookies}/>
            </div>
            <div style={{display: this.state.page === "register" ? "block" : "none"}}>
